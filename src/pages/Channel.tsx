              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between relative">
                ...
                <div className="relative group">
                  <div 
                    ...
                    style={{ backgroundColor: avatarShadowColor, boxShadow: `0 0 20px 5px ${avatarShadowColor}` }}
                  ></div>
                  <img src={channel.avatarUrl} alt={channel.displayName} className="relative h-24 w-24 sm:h-32 sm:w-32 rounded-full object-cover border-4 border-surface" />
                </div>
