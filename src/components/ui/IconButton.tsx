...
export function IconButton({
  ...
  return (
    <button
      {...props}
      className={cn(
        'inline-flex h-10 w-10 items-center justify-center rounded-[10px] border border-border/10 bg-surface text-text transition',
        'hover:bg-surface2 active:translate-y-[1px]',
